...
int TreeLevlKSize(Bt* root, int k)
{
	if (root == NULL)
	{
		return 0;
	...
	return TreeLevlKSize(root->left, k - 1) + TreeLevlKSize(root->right, k - 1);
}
